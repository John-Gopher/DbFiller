srcdir = /root/php54/ext/dbfiller
builddir = /root/php54/ext/dbfiller
top_srcdir = /root/php54/ext/dbfiller
top_builddir = /root/php54/ext/dbfiller
EGREP = /bin/grep -E
SED = /bin/sed
...
RE2C = re2c
AWK = gawk
shared_objects_dbfiller = dbfiller.lo
PHP_PECL_EXTENSION = dbfiller
PHP_MODULES = $(phplibdir)/dbfiller.la
PHP_ZEND_EX =
...
prefix = /usr/local/php
phplibdir = /root/php54/ext/dbfiller/modules
